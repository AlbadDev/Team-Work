...
export default function Home() {
    return (
       <div className='container' style={{justifyContent:'center',alignItems:'center',flexWrap:'wrap'}} >
           <Typography className='headerText' style={{margin:70,fontSize:25,fontFamily:'Raleway '}}>YOUR HOME FOR TIPPING </Typography>
           <hr />
           <Row  xs='1' md='2' lg='2' >
               <Row>
               ...
               <Container className='' >
                   ...
                   <img className='homeImg' src='https://justin-tippr.netlify.app/img/call_to_action_content.png' stype={{marginRight:20}}/>
               </Container>
           </Row>
